...
//        item.items.append( SourceListItem("axis", CodeFragment(.Primitive, "float", "axis", [.Selectable, .Dragable, .Targetable], ["int", "float3"], "float" ) ) )
        ...
        item.items.append( SourceListItem("float2x2", CodeFragment(.VariableDefinition, "float2x2", "", [.Selectable, .Dragable, .Monitorable], ["float", "float", "float", "float"], "float2" ) ) )
        item.items.append( SourceListItem("float3x3", CodeFragment(.VariableDefinition, "float3x3", "", [.Selectable, .Dragable, .Monitorable], ["float", "float", "float", "float"], "float3" ) ) )
        item.items.append( SourceListItem("float4x4", CodeFragment(.VariableDefinition, "float4x4", "", [.Selectable, .Dragable, .Monitorable], ["float", "float", "float", "float"], "float4" ) ) )
        ...
        item.items.append( SourceListItem("fmod", CodeFragment(.Primitive, "float", "fmod", [.Selectable, .Dragable, .Targetable], ["float|float2|float3|float4", "float|float2|float3|float4"], "input0"  ) ) )
        ...
        item = FragItem("G")
        items.append(item)
        item.items.append( SourceListItem("GlobalHash", CodeFragment(.OutVariable, "float", "GlobalHash", [.Selectable, .Dragable, .Targetable], nil, "float") ) )
        item.items.append( SourceListItem("GlobalSeed", CodeFragment(.Primitive, "float", "GlobalSeed", [.Selectable, .Dragable, .Targetable], nil, "float" ) ) )
        ...
        item.items.append( SourceListItem("mix", CodeFragment(.Primitive, "float", "mix", [.Selectable, .Dragable, .Targetable], ["float|float2|float3|float4", "float|float2|float3|float4", "float|float2|float3|float4"], "input0"  ) ) )
        ...
        item = FragItem("P")
        items.append(item)
        item.items.append( SourceListItem("PI", CodeFragment(.Primitive, "float", "PI", [.Selectable, .Dragable, .Targetable], nil, "float" ) ) )
