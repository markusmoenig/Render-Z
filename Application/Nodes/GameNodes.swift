...
class GamePlatformOSX : Node
{
    ...
    override func setupUI(mmView: MMView)
    {
        uiItems = [
            ...
            NodeUINumber(self, variable: "minWidth", title: "Width", range: float2(100, 4096), int: true, value: 800),
            NodeUINumber(self, variable: "minHeight", title: "Height", range: float2(100, 4096), int: true, value: 600)
        ]
