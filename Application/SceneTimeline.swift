...
class SceneTimelineItem {
    ...
    init(_ type: SceneTimelineItemType, stage: Stage, stageItem: StageItem? = nil, component: CodeComponent? = nil, node: CodeComponent? = nil, parentComponent: CodeComponent? = nil)
    {
        itemType = type
        self.stage = stage
