...
class UploadObjectsDialog: MMDialog {
    ...
    init(_ view: MMView, object: StageItem) {
        self.object = object
        super.init(view, title: "Upload Object", cancelText: "Cancel", okText: "Upload")
        instantClose = false
        ...
        nameVar = NodeUIText(c1Node!, variable: "name", title: "Name", value: object.name)
        c1Node!.uiItems.append(nameVar)
        
        var authorName = "Anonymous"
        if object.libraryAuthor.count > 0 {
            authorName = object.libraryAuthor
        }
        ...
        var categoryIndex : Float = 0
        if let cIndex = categoryItems.firstIndex(of: object.libraryCategory) {
            categoryIndex = Float(cIndex)
        }
        ...
        descriptionVar = NodeUIText(c2Node!, variable: "description", title: "Description", value: object.libraryDescription)
        c2Node!.uiItems.append(descriptionVar)
    ...
    override func ok() {
        ...
        object.name = nameVar.value
        object.libraryCategory = categoryItems[Int(categoryVar.index)]
        object.libraryDescription = descriptionVar.value
        object.libraryAuthor = authorVar.value

        let recordID  = CKRecord.ID(recordName: nameVar.value + " :: " + object.libraryCategory)
