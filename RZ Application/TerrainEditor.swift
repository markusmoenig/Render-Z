    ...
    func updateUI()
    {
        ...
        if currentLayerIndex >= 0 {
            ...
            if let shape = currentShape {
                ...
                let shapeBlendVar = NodeUISelector(c2Node!, variable: "shapesBlendMode", title: "Shape Blend Mode", items: ["Distance * Factor", "Factor"], index: Float(layer.shapesBlendType.rawValue), shadows: true)
